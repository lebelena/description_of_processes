...
| 36 | Кликнуть по кнопке «Провести» | Система завершает событие и отображает финальную страницу по событию | |![Событие «Товар поступил на склад»](_images/goods_plus_bpmn07_t26.png){.center width=150} | — |
