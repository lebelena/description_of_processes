...
В состав схемы входит подпроцесс **03.01 — Добавление пространства**, который детализирован на отдельной схеме (см. рисунок 2). Данный подпроцесс используется при сопоставлении пространств списания и поступления как в ветке «Загрузка файлов», так и в ветке «Мануальный режим».

## Подпроцесс 02.02.01 — Заполнение первичной информации (ветка «Загрузка файлов»)
...
Внутри данного подпроцесса вызывается подпроцесс **03.01 — Добавление пространства** (рисунок 4) на шагах сопоставления пространств списания.

## Подпроцесс 02.02.02 — Заполнение первичной информации (ветка «Мануальный режим»)
...
Внутри данного подпроцесса также вызывается подпроцесс **03.01 — Добавление пространства** (рисунок 4) на шагах сопоставления пространств списания и поступления.
...
Подпроцесс является общим для обеих веток («Загрузка файлов» и «Мануальный режим») и вызывается при сопоставлении пространств списания и поступления. Детально сценарии работы с пространствами описаны в таблицах 3.2 и 3.7 текстового описания.
...
Детально сценарии работы с расчётом описаны в таблицах 14, 3.8, 3.9 и 3.10 текстового описания.
