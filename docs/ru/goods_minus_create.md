...
| 27 | Кликнуть по кнопке «Провести» | Система завершает событие и отображает финальную страницу по событию | |![Событие «Товар поступил на склад»](_images/goods_minus_bpmn05_t24.png){.center width=150} | — |
